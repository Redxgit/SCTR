		...
		switch(edroomCurrentTrans.localId)
		{
			...
			case (Do_HK_FDIR):
				...
				if( GSendRecAction() )
				{
					...
					//Branch taken is Do_HK_FDIR_SendRecAction
					edroomCurrentTrans.localId =
						Do_HK_FDIR_SendRecAction;
				...
				else
				{
					...
					//Branch taken is Do_HK_FDIR_NoRecAction
					edroomCurrentTrans.localId =
						Do_HK_FDIR_NoRecAction;
		...
		switch(Msg->signal)
		{
			...
			case (EDROOMSignalTimeout): 
				 ...
				 if (*Msg->GetPInterface() == HK_FDIRTimer)
				{
					...
					//Next transition is  Do_HK_FDIR
					edroomCurrentTrans.localId = Do_HK_FDIR;
					edroomCurrentTrans.distanceToContext = 0 ;
					edroomValidMsg=true;
				 }
