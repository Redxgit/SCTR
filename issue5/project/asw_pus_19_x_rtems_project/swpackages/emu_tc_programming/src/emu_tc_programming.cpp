...
Program12_5TC prog_FT_0060_step0 (UNITIME_AFTER_POWER_ON + 2,
...
Program12_1TC prog_tc9(UNITIME_AFTER_POWER_ON + 5,
                       "Enable Monitoring Param 0",0);


Program19_1TC prog_tc5(UNITIME_AFTER_POWER_ON + 6,
                       "Assign TC(128,2) as action of Event 0x4002",
                       0x4002,
                       128,2);

Program19_4TC prog_tc13(UNITIME_AFTER_POWER_ON + 7,
                       "Enable Action of Event 0x4002",
                       0x4002);

Program20_3TC prog_tc10 (UNITIME_AFTER_POWER_ON + 10,
...
Program19_4TC prog_tc13(UNITIME_AFTER_POWER_ON + 3,
                       "Enable Action of Event 0x4002",
                       0x4002);
