...
Program3_31TC prog_tcx(UNITIME_AFTER_POWER_ON + 100,
                        "(3,31) Change period of SID 0 to 5 seconds",
             0,5);

Program3_6TC prog_tc_disable_SID_0(UNITIME_AFTER_POWER_ON + 200,
				"(3,6) DISABLE SID 0", 0);

Program3_5TC prog_tc_enable_SID_0(UNITIME_AFTER_POWER_ON + 300,
				"(3,5) ENABLE SID 0", 0);
