...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp4->HK_FDIRCtrl, mp_comp2->HK_FDIRCtrl, connections[0], 
					C4HK_FDIRMng_PHK_FDIRCtrl__C2EPDManager_PHK_FDIRCtrl, 
					C2EPDManager_PHK_FDIRCtrl__C4HK_FDIRMng_PHK_FDIRCtrl);
 
	m_localCommSAP.Connect(mp_comp3->TMChannelCtrl2, mp_comp4->TMChannelCtrl, connections[1], 
	...
	m_localCommSAP.Connect(mp_comp5->BKGExecCtrl, mp_comp2->BKGExecCtrl, connections[3], 
					C5BKGTCExec_PBKGExecCtrl__C2EPDManager_PBKGExecCtrl, 
					C2EPDManager_PBKGExecCtrl__C5BKGTCExec_PBKGExecCtrl);
 
	m_localCommSAP.Connect(mp_comp5->TMChannelCtrl, mp_comp3->TMChannelCtrl3, connections[4], 
